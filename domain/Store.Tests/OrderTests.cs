...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void GetItem_WirhExistingItem_RetunsItem()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void GetItem_WirhNonExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void RemoveItem_WirhExistingItem_RemovesItem()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void RemoveItem_WirhNonExistingItem_ThrowInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
